...
namespace VentaPieMVC.Migrations
{
    ...
    [Migration("20200220235008_final")]
    partial class final
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VentaPieMVC.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("VentaPieMVC.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("VentaPieMVC.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("VentaPieMVC.Models.OrderDetail", b =>
                {
                    b.HasOne("VentaPieMVC.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VentaPieMVC.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
